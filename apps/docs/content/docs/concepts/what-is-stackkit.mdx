...
Not every module works with every framework. For example, Prisma and Mongoose are only available for Express projects. Shadcn UI only works with Next.js and React. StackKit knows this, and it won't let you accidentally combine incompatible things.
